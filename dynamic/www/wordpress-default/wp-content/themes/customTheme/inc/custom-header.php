 ...
 */
function customTheme_hex2rgb( $color ) {
	$color = trim( $color, '#' );
...
function customTheme_header_style() {
	...
	?>
	<style type="text/css" id="customTheme-header-css">
	<?php
 ...
 */
function customTheme_header_background_color_css() {
	$color_scheme            = customTheme_get_color_scheme();
	...
	wp_add_inline_style( 'customTheme-style', sprintf( $css, $header_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'customTheme_header_background_color_css', 11 );
 ...
 * @since Custom Theme 2.0
 */
function customTheme_sidebar_text_color_css() {
	$color_scheme       = customTheme_get_color_scheme();
	...
	// If we get this far, we have custom styles. Let's do this.
	$sidebar_link_color_rgb     = customTheme_hex2rgb( $sidebar_link_color );
	...
	wp_add_inline_style( 'customTheme-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
add_action( 'wp_enqueue_scripts', 'customTheme_sidebar_text_color_css', 11 );
