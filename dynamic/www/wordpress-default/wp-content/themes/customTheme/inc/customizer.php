...
function customTheme_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'customTheme' ),
		'section'  => 'colors',
		'type'     => 'select',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		'label'       => __( 'Header and Sidebar Text Color', 'customTheme' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'customTheme' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header and Sidebar Background Color', 'customTheme' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'customTheme' ),
		'section'     => 'colors',
	) ) );

	// Add an additional description to the header image section.
	$wp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'customTheme' );
}
add_action( 'customize_register', 'customTheme_customize_register', 11 );

/**
 * Register color schemes for Twenty Fifteen.
 *
 * Can be filtered with {@see 'customTheme_color_schemes'}.
 *
...
endif; // customTheme_get_color_scheme_choices
 ...
 */
function customTheme_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb         = customTheme_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = customTheme_hex2rgb( $color_scheme[4] );
	$colors = array(
	...
	$color_scheme_css = customTheme_get_color_scheme_css( $colors );

	wp_add_inline_style( 'customTheme-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'customTheme_color_scheme_css' );
 ...
 * @since Custom Theme 2.0
 */
function customTheme_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', customTheme_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'customTheme_customize_control_js' );
...
function customTheme_customize_preview_js() {
	wp_enqueue_script( 'customTheme-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
 ...
 */
function customTheme_get_color_scheme_css( $colors ) {
 ...
 * @since Custom Theme 2.0
 */
function customTheme_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-customTheme-color-scheme">
		<?php echo customTheme_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'customTheme_color_scheme_css_template' );
